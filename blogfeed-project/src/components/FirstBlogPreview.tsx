  ...
  return (
    <div className="px-2 py-10 mx-auto ">
      <div className="mt-8 lg:-mx-6 lg:flex lg:items-center bg-gray-100">
        {/* Image on the left */}
        <img src={blog.image} alt={blog.title} className="object-cover w-full lg:mx-6 lg:w-1/2 h-72 lg:h-96" />

        {/* Text on the right */}
        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6">
          <h2 className="block mt-4 text-2xl font-semibold text-gray-800 hover:underline dark:text-white md:text-3xl">{blog.title}</h2>
          <p className="text-gray-500 mb-2">{blog.date}</p>
          <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">{blog.desc}</p>
          <hr />
